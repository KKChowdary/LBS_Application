 ...
 *
 */
package org.nipun.cisco.dnas.thirdPartApi.service;
...
public class ThirdPartyLoginService {
    ...
    private static final String PATNER_TANENT_ID = "tanent@123456";

    Logger logger = Logger.getLogger(ThirdPartyLoginService.class);
     ...
     * @return
     */
    public JSONObject getNviewAppInfo(final String bearerToken, final String partnerTenantId) {
        ...
        if (PATNER_TANENT_ID.equals(partnerTenantId)) {
            ...
            jsonAuthTokenResponse.put("partnerTenantId", PATNER_TANENT_ID);
     ...
     * @return
     */
    public JSONObject getNviewOAuthToken(final String strRequestBody) {
        ...
        try {
            ...
            if (CLIENT_ID.equals(strClientId) && CLIENT_SECRET_ID.equals(strclientSecret)) {
                ...
                String strTenantId = PATNER_TANENT_ID;
