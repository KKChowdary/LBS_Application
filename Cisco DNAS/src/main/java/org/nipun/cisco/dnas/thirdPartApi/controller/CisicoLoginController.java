 ...
 *
 */
package org.nipun.cisco.dnas.thirdPartApi.controller;
...
import org.nipun.cisco.dnas.thirdPartApi.service.ThirdPartyLoginService;
import org.nipun.cisco.dnas.thirdPartApi.to.LoginTo;
 ...
 */
@RestController
public class CisicoLoginController {
    private static final Logger logger = Logger.getLogger(CisicoLoginController.class);
    private static final String ALPHA_NUMERIC_STRING = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
    private static final String SECRET_KEY = "nview@it123";
    private static final String CLIENT_SECRET_KEY = "nview@it123";
    ...
    public JSONObject getAppInfo(@RequestHeader("Authorization") final String bearerToken,
        ...
        JSONObject response = thirdPartyLoginService.getNviewAppInfo(bearerToken, partnerTenantId);
    ...
    public JSONObject getOAuthToken(@RequestBody final String requestBody) {
        ...
        return thirdPartyLoginService.getNviewOAuthToken(requestBody);
